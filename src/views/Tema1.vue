  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .bg_img_1.mb-3
      .bloque-texto-g.bloque-texto-g.color-terciario.p-3.p-sm-4.p-md-5.mb-5
        ...
        .bloque-texto-g__texto.p-4
          p.mb-0 Para iniciar el cultivo de aguacate es necesario preparar bien el terreno, ya que de esto depende el buen desarrollo de las plantas.
          p.mb-0  Lo primero es hacer una revisión del lote para conocer si el suelo, el clima, la pendiente y la calidad del agua son adecuados para sembrar.
          p.mb-0  A continuación, se abordan los criterios técnicos para la selección del lote y los pasos necesarios para su adecuada preparación, así como las consideraciones prácticas para realizar una siembra eficiente, organizada y productiva.
      ...
      .row.justify-content-center.align-items-center.mb-4
        ...
        .col-12.col-lg-10.mb-5
          p.mb-0 Para establecer una plantación de aguacate es necesario identificar y acondicionar un lote que cumpla con condiciones agroecológicas favorables. Este proceso requiere evaluar tanto las características físicas del terreno como la disponibilidad de servicios esenciales, incluyendo el acceso a fuentes de agua, vías de transporte y barreras naturales contra el viento.
            ...
            SlyderA(tipo="b").tarjeta.tarjeta--blanca.p-4
              .row.justify-content-center.align-items-center
                .col-12.col-lg-6.order-2.order-lg-1.mb-0
                  p.mb-0 El aguacate prospera en suelos profundos, bien drenados, con pH entre 5,5 y 7,0, y con textura franca a franco-arenosa. La profundidad efectiva del suelo debe superar los 60 cm para permitir un adecuado desarrollo radicular. Es crucial evitar zonas con napas freáticas superficiales o suelos compactados que puedan generar encharcamientos y favorecer la aparición de enfermedades radiculares como <I>Phytophthora cinnamomi.</I>
                .col-12.col-lg-4.order-1.order-lg-2.mb-lg-0.mb-3
                  figure
                    img(src='@/assets/curso/temas/tema_1/img_3.png', class="img-fluid")
              .row.justify-content-center.align-items-center
                .col-12.col-lg-6.order-2.order-lg-1.mb-0
                  p.mb-0 La pendiente del terreno ideal no debe superar el 30 %. En laderas, se debe aplicar manejo de conservación de suelos, como la construcción de terrazas, zanjas de infiltración o barreras vivas siguiendo las curvas a nivel. En zonas planas, el lote debe ser nivelado para evitar acumulaciones de agua y facilitar las labores mecanizadas o manuales.
                .col-12.col-lg-4.order-1.order-lg-2.mb-lg-0.mb-3
                  figure
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-12.col-lg-7.order-2.order-lg-1
        p.mb-0 Antes de establecer un cultivo de aguacate, es indispensable conocer las condiciones químicas y físicas del suelo mediante un análisis técnico detallado. Esta evaluación permite determinar los niveles de pH, salinidad, contenido de materia orgánica, textura, capacidad de intercambio catiónico (CIC), conductividad eléctrica, y concentración de nutrientes esenciales. Con base en estos resultados, se formulan recomendaciones específicas sobre el tipo de enmiendas requeridas para acondicionar el suelo y asegurar un entorno favorable para el desarrollo de las raíces y el establecimiento saludable de la plantación.
      ...
      .col-12.col-lg-6
        AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta--color-primario-5")
          div(titulo="Cal agrícola o dolomita")
            p.ps-3.mb-0 Se utiliza para corregir suelos ácidos (pH < 5.5), neutralizando la toxicidad del aluminio y aumentando la disponibilidad de calcio y magnesio. La cal agrícola contiene carbonato de calcio, mientras que la dolomita también aporta magnesio. Se aplica de forma uniforme 30 a 45 días antes de la siembra, según análisis de suelo.
          div(titulo="Yeso agrícola")
            p.ps-3.mb-0 Es ideal para suelos con alto contenido de sodio, ya que mejora la estructura y la permeabilidad sin modificar el pH.  Libera calcio que desplaza el sodio del complejo de intercambio, facilitando su lavado con riego o lluvia. Su uso está indicado especialmente en suelos compactados o con encostramiento superficial.
          div(titulo="Materia orgánica")
            p.ps-3.mb-0 Aporta nutrientes, mejora la estructura y retención de agua, y activa la vida microbiana del suelo. Se recomienda compost bien descompuesto, estiércol tratado o <i>bokashi</i>, aplicados antes de la siembra o alrededor del árbol en producción. Su uso continuo contribuye a la sostenibilidad del cultivo y la salud del suelo.
    ...
    .bloque-texto-t.justify-content-center.align-items-center.mb-0
      ...
      .bloque-texto-t__texto.col-10.mb-0
        p.mb-0 Después de la siembra, se recomienda realizar un seguimiento semanal para verificar prendimiento, detectar posibles problemas sanitarios y realizar resiembras en caso necesario.  Durante los primeros tres meses, el árbol debe mantenerse libre de malezas, bien tutorado y con humedad constante en el plato. El éxito de esta etapa garantiza un sistema radicular fuerte y una planta bien conformada para iniciar el ciclo productivo.
